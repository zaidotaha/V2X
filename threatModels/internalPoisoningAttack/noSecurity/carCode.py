...
class car:
    ...
    def line_tracking(self, px_power, offset):
    ...
    def obstacle_avoidance(self, client):
        ...
        if (pers >= 3):
            ...
            print("yo")
            if(turned_left == True):
                client.publish(b"0000000003Don't go left")
            elif(turned_right == True):
                client.publish(b"0000000003Don't go right")
            quit()  
...
if __name__=='__main__':
    ...
    try:
        while True:
            ...
            if(car1.line_tracking(0.1,10)==False):
                break
    finally:
        car1.stop()
